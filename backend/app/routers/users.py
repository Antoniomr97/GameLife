...
def list_all_users(
    ...
    """Retorna la lista completa de usuarios registrados. Requiere privilegios de administrador."""
...
def delete_user(
    ...
    """Elimina permanentemente un usuario y todo su contenido asociado. Solo para administradores."""
    if not current_user.is_admin:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Acceso restringido a administradores"
